...
[
  {
    "body": "<!-- trainer-codereview-opacite-feat-wave4-rescan-scheduler -->\n<!-- head=805402b verdict=APPROVE round=1 -->\n\n### Bug inventory\n\nNo P0–P4 findings — fixture self-test.\n\n### Trainer notes\n\n1. **Program notes:** test\n2. **Your form:** test\n3. **Next session:** test\n"
  }
]
JSON

TRAINER_PR_REVIEW_FIXTURE="$good" \
  bash "$GATE" 99 805402b886b160d3acaf9130cba1363edb1a4d7e feat/wave4-rescan-scheduler weijia-89/opacite \
...
echo '[{"body": "<!-- trainer-codereview-opacite-feat-x -->\n<!-- head=abcdef0 verdict=APPROVE -->\n### Trainer notes\n1. **Program notes:** x\n2. **Your form:** x\n3. **Next session:** x\n"}]' >"$bad_inv"
TRAINER_PR_REVIEW_FIXTURE="$bad_inv" \
  bash "$GATE" 1 abcdef0123456789abcdef0123456789abcdef0 feat/x weijia-89/opacite \
...
TRAINER_PR_REVIEW_FIXTURE="$empty" \
  bash "$GATE" 1 abcdef0 feat/x weijia-89/opacite \
