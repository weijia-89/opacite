...
Requires birthdate for match — higher wrong-person risk.

## Opt-out entry points

| Channel | Location | Notes |
|---------|----------|-------|
| Primary | https://checkpeople.com/opt-out | Operator-verified entry point |
...
1. Birthdate required — verify match carefully.
2. Submit opt-out.
...
Tier **B**; enforce match_score manual review.
