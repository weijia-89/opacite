# Instant Checkmate — operator playbook
...
PeopleConnect brand with intermittent CAPTCHA; self-service suppression.
...
- Data subject completes portal
- Intermittent CAPTCHA

## Manual steps

1. Export self-service task to data subject.
2. Subject uses PeopleConnect suppression portal.
3. Solve CAPTCHA if presented during subject session.
4. Confirm via email.
5. Operator stores evidence; no automated Playwright on behalf of subject.
