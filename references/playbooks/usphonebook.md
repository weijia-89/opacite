...
Simple people-search opt-out.

## Opt-out entry points

| Channel | Location | Notes |
|---------|----------|-------|
| Primary | https://www.usphonebook.com/opt-out | Operator-verified entry point |
...
1. Complete opt-out form.
2. Verify listing removed.
3. Rescan.
