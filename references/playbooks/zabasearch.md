...
PeopleConnect family; self-service suppression.
...
- Data subject portal completion

## Manual steps

1. Export self-service instructions.
2. Subject completes PeopleConnect suppression.
3. Log completion with screenshot.
4. Rescan ZabaSearch specifically.
