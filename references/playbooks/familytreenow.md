# FamilyTreeNow — operator playbook
...
Genealogy-leaning people-search with simple opt-out.

## Opt-out entry points

| Channel | Location | Notes |
|---------|----------|-------|
| Primary | https://www.familytreenow.com/optout | Operator-verified entry point |
...
1. Search and opt out via form.
2. Confirm.
3. Rescan — genealogy sources may re-ingest.
