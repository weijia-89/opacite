...
CAPTCHA-gated opt-out with email verification.

## Opt-out entry points

| Channel | Location | Notes |
|---------|----------|-------|
| Primary | https://www.peekyou.com/about/contact/optout | Operator-verified entry point |
...
1. Locate PeekYou profile.
2. Submit opt-out contact form.
3. Solve CAPTCHA.
