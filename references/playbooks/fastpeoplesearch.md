# FastPeopleSearch — operator playbook
...
SimilarWeb top-5 traffic; web opt-out with CAPTCHA.

## Opt-out entry points

| Channel | Location | Notes |
|---------|----------|-------|
| Primary | https://www.fastpeoplesearch.com/optout | Operator-verified entry point |
...
- Name
- Email
- Profile URL or record identifier

## Manual steps

1. Locate record via search.
2. Submit opt-out form with profile details.
3. Solve CAPTCHA.
4. Confirm via email if prompted.
5. Verify profile absent on rescan.
