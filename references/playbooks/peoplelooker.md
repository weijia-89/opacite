# PeopleLooker — operator playbook
...
BeenVerified-family people-search.

## Opt-out entry points

| Channel | Location | Notes |
|---------|----------|-------|
| Primary | https://www.peoplelooker.com/opt-out | Operator-verified entry point |
...
1. BeenVerified subsidiary — similar match discipline.
2. Submit opt-out; verify email.
3. Check sibling brands if data persists.
4. Rescan.
